...
export const renderTrafficStatus = (serverConfig: ComputedServerConfig, health: H.Health) => {
...
export class HealthDetails extends React.PureComponent<Props, {}> {
  renderErrorRate = (serverConfig: ComputedServerConfig, item: H.HealthItem, idx: number) => {
  ...
  renderChildren = (serverConfig: ComputedServerConfig, item: H.HealthItem, idx: number) => {
