...
import { DurationInSeconds, Metric, RichDataPoint, VCLine } from '../../../types/';
...
import { toLocaleStringWithConditionalDate } from '../../../utils';
        ...
        {series.length > 0 && (
          <>
            ...
            <SparklineChart
              ...
              tooltipFormat={dp => `${toLocaleStringWithConditionalDate(dp.x as Date)}\n${dp.y.toFixed(2)} ${dp.name}`}
              series={series}
              labelName="ops"
            />
          </>
