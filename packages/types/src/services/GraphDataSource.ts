...
export class GraphDataSource {
  ...
  private serverConfig: ComputedServerConfig;
  ...
  private decoratedData = createSelector(
    ...
    (graphData, duration) => decorateGraphData(this.serverConfig, graphData, duration)
  );

  // Public methods

  constructor(serverConfig: ComputedServerConfig) {
