...
import { ComputedServerConfig, ServiceDetailsInfo, WorkloadOverview, AppWorkload } from '@kiali/types';
import Labels from '../../components/Label/Labels';
import { style } from 'typestyle';
import LocalTime from '../../components/Time/LocalTime';
import { renderAPILogo } from '../../components/Logo/Logos';
import { TextOrLink } from '../Link/TextOrLink';
    ...
    if (this.props.serviceDetails) {
      if (this.props.serviceDetails.workloads) {
        this.props.serviceDetails.workloads
          ...
          .forEach(wk => {
            if (wk.labels) {
              const appName = wk.labels[this.props.serverConfig.istioLabels.appLabelName];
