...
import { decoratedNodeData } from '../CytoscapeGraph/CytoscapeGraphUtils';
...
export const getNodeMetrics = (
  ...
  switch (nodeMetricType) {
    case NodeMetricType.AGGREGATE:
      return getAggregateMetrics(nodeData.namespace, nodeData.aggregate!, nodeData.aggregateValue!, options);
    case NodeMetricType.APP:
      return getAppMetrics(nodeData.namespace, nodeData.app!, options);
    case NodeMetricType.SERVICE:
      return getServiceMetrics(nodeData.namespace, nodeData.service!, options);
    case NodeMetricType.WORKLOAD:
      return getWorkloadMetrics(nodeData.namespace, nodeData.workload!, options);
    default:
