...
import history, { URLParam, HistoryManager } from '../../utils/History';
import {
  ActiveFilter,
  ActiveFiltersInfo,
...
export const currentDuration = (serverConfig: ComputedServerConfig): number => {
  return HistoryManager.getDuration(serverConfig) || defaultDuration;
};
