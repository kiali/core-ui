...
export class IstioMetrics extends React.Component<Props, MetricsState> {
  ...
  private fetchMetrics = () => {
    ...
    MetricsHelper.timeRangeToOptions(this.props.serverConfig, this.props.timeRange, this.options);
    ...
    switch (this.props.objectType) {
      case MetricsObjectTypes.WORKLOAD:
        promise = getWorkloadDashboard(this.props.namespace, this.props.object, opts);
        break;
      case MetricsObjectTypes.APP:
        promise = getAppDashboard(this.props.namespace, this.props.object, opts);
        break;
      case MetricsObjectTypes.SERVICE:
      default:
        promise = getServiceDashboard(this.props.namespace, this.props.object, opts);
        break;
    }
    return promise
      .then(response => {
  ...
  private fetchGrafanaInfo() {
    if (!IstioMetrics.grafanaInfoPromise) {
      IstioMetrics.grafanaInfoPromise = getGrafanaInfo().then(response => {
