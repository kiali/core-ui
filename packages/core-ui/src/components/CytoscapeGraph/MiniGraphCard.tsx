...
import { GraphUrlParams, makeNodeGraphUrlFromParams } from '../../utils/NavUtils';
...
export class MiniGraphCard extends React.Component<MiniGraphCardProps, MiniGraphCardState> {
  ...
  private onViewNodeGraph = () => {
    ...
    const urlParams: GraphUrlParams = {
      ...
      edgeLabels: this.props.dataSource.fetchParameters.edgeLabels,
      edgeMode: EdgeMode.ALL,
      graphLayout: this.props.graphSettings.layout,
      namespaceLayout: this.props.graphSettings.namespaceLayout,
      graphType: graphType,
      node: this.props.dataSource.fetchParameters.node!,
      refreshInterval: this.props.userSettings.refreshInterval,
