...
export function NodeContextMenu(props: Props) {
  ...
  function getDropdownItemTooltipMessage(): string {
    if (props.serverConfig.deployment.viewOnlyMode) {
  ...
  function renderHeader() {
    return (
      <>
        ...
        {renderBadgedName(props.serverConfig, props)}
      </>
    );
  }
  ...
  function renderDeleteTrafficRoutingItem() {
    if (
      !canDelete(props.serverConfig, serviceDetails?.istioPermissions) ||
  ...
  function renderFullContextMenu(serverConfig: ComputedServerConfig, linkParams: LinkParams) {
    ...
    const options: ContextMenuOption[] = getOptionsFromLinkParams(serverConfig, linkParams, props.jaegerInfo);
    const menuOptions = (
      <>
  ...
  return renderFullContextMenu(props.serverConfig, linkParams);
}
...
export const getOptions = (
  ...
  return getOptionsFromLinkParams(serverConfig, linkParams, jaegerInfo);
};

const getOptionsFromLinkParams = (
  serverConfig: ComputedServerConfig,
