...
import { AppWorkload, ComputedServerConfig, Health, HealthSubItem, isGateway } from '@kiali/types';
  ...
  render() {
    return (
      <>
        ...
        {this.props.health && renderTrafficStatus(this.props.serverConfig, this.props.health)}
      </>
    );
  }
}
