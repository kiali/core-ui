...
import { averageSpanDuration, StatsMatrix, JaegerTrace, PFColors, formatDuration } from '@kiali/types';
    ...
    if (this.props.activePoints && this.props.activePoints.length > 0) {
      ...
      return (
        <HookedChartTooltip
          ...
          labelComponent={<TraceLabel trace={trace} isStatsMatrixComplete={true} />}
        />
      );
    }
    return null;
