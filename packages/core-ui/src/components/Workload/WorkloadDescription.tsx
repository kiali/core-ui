...
import { Health, Workload, hasMissingAuthPolicy, isGateway, ComputedServerConfig } from '@kiali/types';
...
import MissingSidecar from '../../components/Missing/MissingSidecar';
import { PFBadge, PFBadges } from '../../components/Pf/PfBadges';
import MissingLabel from '../../components/Missing/MissingLabel';
import MissingAuthPolicy from '../../components/Missing/MissingAuthPolicy';
...
class WorkloadDescription extends React.Component<WorkloadDescriptionProps> {
  render() {
    ...
    if (workload) {
      if (workload.labels[this.props.serverConfig.istioLabels.appLabelName]) {
        apps.push(workload.labels[this.props.serverConfig.istioLabels.appLabelName]);
      }
        ...
        <CardHeader>
          <Title headingLevel="h5" size={TitleSizes.lg}>
            ...
            <span className={healthIconStyle}>
              <HealthIndicator id={workload.name} health={this.props.health} serverConfig={this.props.serverConfig} />
            </span>
